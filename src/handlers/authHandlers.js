...
const registerHandler = async (req, res) => {
    const { name, last_name, rol, email, password, payment, countryId } = req.body;
    ...
    try {
        ...
        const user = await User.create({ name, last_name, rol, email, password: passwordHash, payment, countryId });
